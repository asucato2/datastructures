...
namespace DataStructures
{
  ...
  protected:
    ...
    int _startIndex; // index of first element
    int _endIndex; // index of next available index
    int _size; // number of elements in store
    int _capacity; // number of elements store can hold
